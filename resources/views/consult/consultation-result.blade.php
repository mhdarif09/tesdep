      ...
      <div class="w-6/12 bg-white shadow-md rounded-lg px-4 py-6 space-y-8">
        ...
        @if ($user_history->result != "0" && $user_history->result !== "")
          ...
          <div class="space-y-6">
            ...
            <p>
              Untuk informasi lebih lanjut Anda dapat menghubungi <b>Direktorat Pencegahan dan Pengendalian Masalah Kesehatan Mental dan Obat</b> di <b>119</b> atau <b>TesDep</b> di <b>+6283173908515</b>.
            </p>
          </div>
